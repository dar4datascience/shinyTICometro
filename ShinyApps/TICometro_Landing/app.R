...
# Creating Variables and modifying structure ------------------------------
...
myTheme <-
  create_theme(
    #FIND MORE CUSTOMIZATION AT fresh::search_vars_bs4dash("navbar")
    bs4dash_vars(
    ...
    bs4dash_color(
      #main colors of bs4dash. as used by the app
      blue = NULL,
      lightblue = NULL,
      navy = NULL,
      cyan = NULL,
      teal = NULL,
      olive = "#026928",
      #change to fit buton profesores
      green = NULL,
      lime = NULL,
      orange = NULL,
      yellow = NULL,
...
body = dashboardBody(
  ...
  tags$div(
    #entrap all elements in a white background div
    br(),
    fluidRow(
