...
navbarMenu <- function(..., id = NULL) {
  if (is.null(id))
    #generation of ids in tabs navbar
...
header = bs4Dash::dashboardHeader(
  ...
  # Nav bar tabs
  navbarMenu(
    navbarTab(tabName = "enp", "ENP"),
    navbarTab(tabName = "cch", "CCH"),
    navbarTab(tabName = "descarga",
              icon = ionicon(name = "cloud-download"),
              tags$p("Descarga", id = "descarga-nav-title")
              )
  )
),#HEADER ENDS
