...
Por orden de Angelica se va a borrar el registro correspondiente al ENP 2 grupo 104. El Alumno 1802 se colo porque es de iniciacion secundaria.

```{r deleteSpecial}
TICometro_2021_clean <- TICometro_2021_clean %>% 
  filter(!(num_alumno == "Alumno 1802" & institucion == "ENP 2"))
```
